      ...
      <nav className="fixed z-[9999] border-b-slate-400 border-b w-full bg-gray-100 font-Poppins dark:bg-dark dark:border-b dark:border-border dark:border-b-slate-600">
            ...
            <div className="flex w-full justify-between">
              <div className="max-lg:item-start max-lg:mx-0">
                <a href="/" className="flex items-center px-2 py-4">
                  <span className={` ${poppins.className} poppins text-2xl font-bold text-dark dark:text-light`}>Gamada24</span>
                </a>
              </div>
        ...
        <div ref={myRef} className="mobile-menu hidden md:hidden">
          <ul className="mx-5">
            ...
            <li>
              <a href="/#Day2" className=" block border-b-[1px] border-dartext-dark px-2 py-4 text-sm font-semibold text-gray-600 dark:text-light transition duration-300 hover:bg-gray-200 ">
                Day 2 dan 5
              </a>
            </li>
            <li>
